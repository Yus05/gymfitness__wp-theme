...
function gymfitness_scripts_styles(){
    ...
    if(is_front_page()){
        wp_enqueue_style('swiper-css', 'https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css', array(), '11.2.0'); 
    }
    ...
    if(is_front_page()){
        wp_enqueue_script('swiper-js', 'https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js', array(), '11.2.0', true);
...
function gymfitness_ubicacion_shortcode(){
    ...
    <?php
    echo do_shortcode('[contact-form-7 id="1ddb87d" title="Formulario de contacto 1"]');
}
...
function gymfitness_hero_imagen(){
    // Obtener el ID de la pagina de inicio (cuando se crean la pagina en WP, este le asigna id aleatorios)
